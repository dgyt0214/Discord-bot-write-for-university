...
class kick (Cog_Extension):
    ...
    @nextcord.slash_command(name='introduce')
    async def introduce(self,interaction:nextcord.interactions,mes:User=nextcord.SlashOption(name='要查詢的人',required=False)):
